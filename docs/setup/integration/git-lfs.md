...
![git-lfs](../../resource/setup/git-lfs.png)
...
![git-lfs-download](../../resource/setup/git-lfs-download.png)
...
![git-lfs-p2p](../../resource/setup/git-lfs-p2p.png)
...
![git-lfs-dragonfly](../../resource/setup/git-lfs-dragonfly.png)
