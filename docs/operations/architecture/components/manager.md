...
id: manager
title: Manager
slug: /operations/architecture/components/manager/
---
...
![manage-multiple-p2p-networks](../../../resource/operations/architecture/components/manager/manage-multiple-p2p-networks.png)
