...
id: client
title: Client
slug: /operations/architecture/components/client/
---
...
![client-donwload-hit-local-peer-cache](../../../resource/operations/architecture/components/client/client-donwload-hit-local-peer-cache.svg)

### Hit Remote Peer Cache

![client-download-hit-remote-peer](../../../resource/operations/architecture/components/client/client-download-hit-remote-peer.svg)

### Download From Source

![client-download-back-to-source](../../../resource/operations/architecture/components/client/client-download-back-to-source.svg)
