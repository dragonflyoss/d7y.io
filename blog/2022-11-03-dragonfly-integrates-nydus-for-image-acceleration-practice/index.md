...
For detailed installation documentation based on kubernetes cluster, please refer to [quick-start-kubernetes](/docs/next/getting-started/quick-start/kubernetes/lightweight-deployment).
