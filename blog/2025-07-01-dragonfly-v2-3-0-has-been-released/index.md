...
For documentation on how to use the dfcache command-line tool, please refer to the following link: [dfcache](https://d7y.io/docs/next/reference/commands/client/dfcache/).
