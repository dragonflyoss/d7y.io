          ...
          <div className="row">
            <p className={clsx("hero__subtitle", styles.description)}>
              <Translate>
                ...
                problems in cloud native scenarios. It is now hosted by the
                Cloud Native Computing Foundation (CNCF) as an Incubating Level
                Project. Originally it was born to solve all kinds of
                distribution at very large scales, such as application
                distribution, cache distribution, log distribution, image
